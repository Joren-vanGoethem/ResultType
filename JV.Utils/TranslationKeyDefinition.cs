...
namespace JV.Utils
{
    public class TranslationKeyDefinition
    {
        ...
        private TranslationKeyDefinition(string key, string translationKey, IEnumerable<TranslationParameter> parameters)
        {
        ...
        public static TranslationKeyDefinition Create(string key, string translationKey, params TranslationParameter[] parameters)
        {
