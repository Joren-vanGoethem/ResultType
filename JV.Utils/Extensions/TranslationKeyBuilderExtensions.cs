...
namespace JV.Utils.Extensions
{
    ...
    {
        public static TranslationKeyDefinition WithStringParameter(this TranslationKeyDefinition definition, string name)
        {
        ...
        public static TranslationKeyDefinition WithDecimalParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
        ...
        public static TranslationKeyDefinition WithDateTimeParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
        ...
        public static TranslationKeyDefinition WithTimeOnlyParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
        ...
        public static TranslationKeyDefinition WithDateOnlyParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
        ...
        public static TranslationKeyDefinition WithBooleanParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
        ...
        public static TranslationKeyDefinition WithTimeSpanParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
        ...
        public static TranslationKeyDefinition WithPhoneNumberParameter(this TranslationKeyDefinition definition, string name)
        {
            var parameters = new List<TranslationParameter>(definition.Parameters)
            {
